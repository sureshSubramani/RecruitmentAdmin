        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url()?>dashboard" class="site_title text-center"><i class="fa fa-paw"></i> <span>Mahendra</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class="<?php if($this->uri->uri_string() == 'profile_list') { echo 'active'; } ?>"><a href="<?php echo base_url()?>profile_list"><i class="fa fa-users"></i> List of Profiles</a></li>                  
                  <li class="<?php if($this->uri->uri_string() == 'team_data') { echo 'active'; } ?>"><a href="<?php echo base_url()?>team_data"><i class="fa fa-database"></i> Team Data</a></li>                                    
