...
class Offer extends CI_Controller {
	...
	public function index(){
        ...
        $data['title'] = 'No Due Form';

        //$this->load->view('common/header', $data);
        $this->load->view('no_due', $data);
        //$this->load->view('common/footer');                                 
    }

    public function no_due_download(){ 
                //load mPDF library
                ...
                $html_profile = $this->load->view('no_due',$this->data, true); //load the pdf_output.php by passing our data and get all data in $html varriable.
